...
while time.time() < t_end:
    ...
    image_diff = cv2.subtract(image_old_gray, image_new_gray)
    # Gaussian blur the difference image to combat noise
    image_diff_gblur = cv2.GaussianBlur(image_diff, (15,15), 0)
    # Compute difference score as grand sum of gray pixel value of difference image
    diff_score = np.sum(image_diff)
    if diff_score >= 50000000 or diff_score <= 10000000:
        ...
        imagepath = "/home/pi/Desktop/Images_Drosophila/"
